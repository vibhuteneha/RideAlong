...
function ven($id,$con){
	...
	$sql="Select  * from users inner join passenger on users.sno=passenger.uid where passenger.uid='".$id."'";
...
$jobj = json_encode(array('passengerDetails' => $Juser), JSON_FORCE_OBJECT);
